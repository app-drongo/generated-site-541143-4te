// Enhanced by AI on 2025-08-15T09:01:56.114Z
// Section: footer
// Category: footer
  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Meet the Makers", href: "/about#makers" },
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              <Link href="/" className="flex items-center space-x-2 mb-4">
                ...
                <span className="font-bold text-xl">Jewel Artisan</span>
              </Link>
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Discover the beauty of handcrafted jewelry at Jewel Artisan. Our collection
                features unique, one-of-a-kind pieces made by local artisans. Shop now and
                find the perfect accessory to elevate your style.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">hello@jewelartisan.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">456 Artisan Alley, Suite 200</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Get the latest updates on new collections and special offers. Unsubscribe anytime.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <span>© 2024 Jewel Artisan. All rights reserved.</span>
