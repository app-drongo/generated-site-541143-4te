// Enhanced by AI on 2025-08-15T09:01:25.387Z
// Section: hero
// Category: hero
        ...
        <div className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
              Elevate your style with our exquisite collection of handcrafted jewelry. 
              Explore a world of one-of-a-kind pieces that will make you stand out.
            </p>
